...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("green maize.jpg"));
	...
	private void scare() {
		...
		// name of your sound file.
		 AudioClip sound =
		JApplet.newAudioClip(getClass().getResource("kill.wav"));
...
showScaryImage("are you serious.jpg");
	}
